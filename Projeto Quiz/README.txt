...
4- Altere as informações dentro do arquivo .env caso seja necessario
...
5- apos as instalação das dependencias você colocará 'npm start' no front e 'npm run start:dev' no back
